...
export function observe(dataTables: DataTables, tableName: keyof DataTables) {
...
export function putReplacer<T extends ConcreteRecord>(
  table: DataTable<T>,
...
export function deleteReplacer<T extends ConcreteRecord>(
  table: DataTable<T>,
  tableName: keyof DataTables,
...
export function withWithVersion(
  dataTables: DataTables,
  db: DynamoDBDocument,
  tableName: keyof DataTables
