...
export type AttachFileToNotebookMutation = {
  __typename?: 'Mutation';
  attachFileToPad?: { __typename?: 'Attachment'; url: string } | null;
};
...
export type FulfilGoalMutation = {
  __typename?: 'Mutation';
  fulfilGoal: boolean;
};
...
export type SetNotebookPublicMutation = {
  __typename?: 'Mutation';
...
export type IncrementQueryCountMutation = {
  __typename?: 'Mutation';
  incrementQueryCount: {
    __typename?: 'WorkspaceExecutedQuery';
    queryCount: number;
...
export type WorkspaceExecutedQueryDataFragment = {
  __typename?: 'WorkspaceExecutedQuery';
  queryCount: number;
  quotaLimit: number;
};
...
export type UserQuery = {
  __typename?: 'Query';
  selfFulfilledGoals: Array<string>;
  self?: {
    __typename?: 'User';
    id: string;
    name: string;
...
export type DashboardWorkspaceFragment = {
  __typename?: 'Workspace';
  id: string;
  name: string;
  isPremium?: boolean | null;
...
`;
export const WorkspaceExecutedQueryDataFragmentDoc = gql`
...
export function useFulfilGoalMutation() {
  return Urql.useMutation<FulfilGoalMutation, FulfilGoalMutationVariables>(
    FulfilGoalDocument
  );
}
...
export function useSetNotebookPublicMutation() {
  return Urql.useMutation<
    SetNotebookPublicMutation,
    SetNotebookPublicMutationVariables
  >(SetNotebookPublicDocument);
}
...
export const IncrementQueryCountDocument = gql`
  mutation IncrementQueryCount($id: ID!) {
    incrementQueryCount(id: $id) {
      queryCount
      quotaLimit
    }
  }
...
export function useIncrementQueryCountMutation() {
  return Urql.useMutation<
    IncrementQueryCountMutation,
    IncrementQueryCountMutationVariables
  >(IncrementQueryCountDocument);
}
...
export function useGetWorkspacesQuery(
  options?: Omit<Urql.UseQueryArgs<GetWorkspacesQueryVariables>, 'query'>
) {
  return Urql.useQuery<GetWorkspacesQuery, GetWorkspacesQueryVariables>({
...
export type GraphCacheKeysConfig = {
  ...
  ExternalDataSourceAccess?: (
    data: WithTypename<ExternalDataSourceAccess>
  ) => null | string;
...
export type GraphCacheResolvers = {
  Query?: {
    ...
    getExternalDataSources?: GraphCacheResolver<
      ...
      WithTypename<PagedResult> | string
    >;
    ...
    self?: GraphCacheResolver<
      ...
      WithTypename<User> | string
    >;
    selfFulfilledGoals?: GraphCacheResolver<
      WithTypename<Query>,
      Record<string, never>,
  ...
  ExternalDataSource?: {
    access?: GraphCacheResolver<
      ...
      Record<string, never>,
      WithTypename<ExternalDataSourceAccess> | string
    >;
  ...
  ExternalDataSourceAccess?: {
    roles?: GraphCacheResolver<
      WithTypename<ExternalDataSourceAccess>,
      Record<string, never>,
  ...
  PadAccess?: {
    ...
    secrets?: GraphCacheResolver<
      WithTypename<PadAccess>,
      Record<string, never>,
      Array<WithTypename<SecretAccess> | string>
    >;
    users?: GraphCacheResolver<
      WithTypename<PadAccess>,
      Record<string, never>,
  ...
  User?: {
    ...
    emailValidatedAt?: GraphCacheResolver<
      ...
      Scalars['DateTime'] | string
    >;
    hideChecklist?: GraphCacheResolver<
      WithTypename<User>,
      Record<string, never>,
      Scalars['Boolean'] | string
    >;
  ...
  WorkspaceSubscription?: {
    customer_id?: GraphCacheResolver<
...
export type GraphCacheOptimisticUpdaters = {
  ...
  duplicatePad?: GraphCacheOptimisticMutationResolver<
    ...
    WithTypename<Pad>
  >;
  fulfilGoal?: GraphCacheOptimisticMutationResolver<
    MutationFulfilGoalArgs,
    Scalars['Boolean']
  >;
  ...
  movePad?: GraphCacheOptimisticMutationResolver<
    ...
    WithTypename<Pad>
  >;
  pretendUser?: GraphCacheOptimisticMutationResolver<
    MutationPretendUserArgs,
    Maybe<Scalars['Boolean']>
  >;
...
export type GraphCacheUpdaters = {
  Mutation?: {
    ...
    duplicatePad?: GraphCacheUpdateResolver<
      ...
      MutationDuplicatePadArgs
    >;
    fulfilGoal?: GraphCacheUpdateResolver<
    ...
    movePad?: GraphCacheUpdateResolver<
      ...
      MutationMovePadArgs
    >;
    pretendUser?: GraphCacheUpdateResolver<
