...
export const commands: Command[] = [
  ...
  },
  {
    ...
    mode: 'inline',
    title: 'Bold',
    description: 'Start typing bold text',
    darkImage: getDarkImage('Bold'),
    lightImage: getLightImage('Bold'),
  },
  {
    type: 'italic',
    mode: 'inline',
    title: 'Italic',
    description: 'Start typing italic text',
    darkImage: getDarkImage('Italic'),
    lightImage: getLightImage('Italic'),
  },
  {
    type: 'underline',
    mode: 'inline',
    title: 'Underline',
    description: 'Start typing text that is underlined',
    darkImage: getDarkImage('Underline'),
    lightImage: getLightImage('Underline'),
  },
  {
    type: 'strikethrough',
    mode: 'inline',
    title: 'Strike through',
    description: 'Start typing text that has a strike through',
    darkImage: getDarkImage('Strikethrough'),
    lightImage: getLightImage('Strikethrough'),
  },
];
