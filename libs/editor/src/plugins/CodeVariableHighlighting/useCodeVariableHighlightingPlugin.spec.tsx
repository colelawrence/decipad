...
const PlateWrapper = ({ children }: Pick<CodeBlockElement, 'children'>) => (
  <Plate
    initialValue={[
      {
    ...
    plugins={[createCodeBlockPlugin(), useCodeVariableHighlightingPlugin()]}
  />
);
...
describe('variable highlights', () => {
  it('show bubbles in variable declarations', () => {
    ...
    const { getByText } = render(<PlateWrapper children={children} />);
