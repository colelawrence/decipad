...
export const expansions: Partial<Expansions> = {
  force: {
    ...
    convertToExpanded: (newton) => newton.mul(1000),
  },
  pressure: {
    expandedUnits: [
    ...
    convertToExpanded: (atmospheres) => atmospheres.mul(101325),
  },
  area: {
  ...
  energy: {
    ...
    convertToExpanded: (joules) => joules.mul(1000),
  },
  power: {
    expandedUnits: [
      { baseQuantity: 'mass', exp: 1 },
    ...
    convertToExpanded: (watts) => watts.mul(1000),
  },
  'electric charge': {
    expandedUnits: [
  ...
  voltage: {
    ...
    convertToExpanded: (volts) => volts.mul(1000),
  },
  'electrical capacitance': {
    ...
    convertToExpanded: (farads) => farads.div(1000),
  },
  'electrical resistance': {
    ...
    convertToExpanded: (ohms) => ohms.mul(1000),
  },
  'electrical conductance': {
    ...
    convertToExpanded: (siemens) => siemens.div(1000),
  },
};
