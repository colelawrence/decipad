  ...
  it('References to automatically generated varnames which are missing, are errors', async () => {
    ...
    expect(await inferExpression(realm, r('AutoGenerated')))
      ...
      Type {
        ...
        "date": null,
        "delegatesIndexTo": undefined,
        "errorCause": [Error: Inference Error: unknown-reference : {"errType":"unknown-reference","refName":"AutoGenerated"}],
        "functionArgNames": undefined,
        "functionBody": undefined,
        "functionName": undefined,
        "functionScopeDepth": undefined,
...
it('infers binops', async () => {
  ...
  expect(
    (await inferExpression(errorRealm, badExpr)).errorCause
  ).toMatchInlineSnapshot(
    `[Error: Inference Error: expected-but-got : {"errType":"expected-but-got","expectedButGot":["number",{"node":null,"errorCause":null,"type":"boolean","unit":null,"numberFormat":null,"numberError":null,"date":null,"rangeOf":null,"indexName":null,"indexedBy":null,"cellType":null,"atParentIndex":null,"columnTypes":null,"columnNames":null,"rowIndexName":null,"rowCellTypes":null,"rowCellNames":null,"functionness":false,"pending":false,"nothingness":false,"anythingness":false,"symbol":null}]}]`
  );
});
