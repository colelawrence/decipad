...
var grammar = {
    ...
    {"name": "date", "symbols": [{"literal":"Y"}, "dateYear"], "postprocess": 
        (d, l) => ({
          type: 'date',
          args: [
            'year',
    ...
    {"name": "date", "symbols": ["dateYear", "dateSeparator", "dateMonth"], "postprocess": 
        (d, l) => ({
          type: 'date',
          args: [
            'year',
    ...
    {"name": "date", "symbols": ["dateYear", "dateSeparator", "dateMonth", "dateSeparator", "dateDay"], "postprocess": 
        (d, l) => ({
          type: 'date',
          args: [
            'year',
    ...
    {"name": "date", "symbols": ["dateYear", "dateSeparator", "dateMonth", "dateSeparator", "dateDay", "date$subexpression$1", "dateHour"], "postprocess": 
        (d, l) => ({
          type: 'date',
          args: [
            'year',
    ...
    {"name": "date", "symbols": ["dateYear", "dateSeparator", "dateMonth", "dateSeparator", "dateDay", "date$subexpression$2", "dateHour", {"literal":":"}, "dateMinute"], "postprocess": 
        (d, l) => ({
          type: 'date',
          args: [
            'year',
    ...
    {"name": "date", "symbols": ["dateYear", "dateSeparator", "dateMonth", "dateSeparator", "dateDay", "date$subexpression$3", "dateHour", {"literal":":"}, "dateMinute", {"literal":":"}, "dateSecond"], "postprocess": 
        (d, l) => ({
          type: 'date',
          args: [
            'year',
    ...
    {"name": "date", "symbols": ["dateYear", "dateSeparator", "dateMonth", "dateSeparator", "dateDay", "date$subexpression$4", "dateHour", {"literal":":"}, "dateMinute", {"literal":":"}, "dateSecond", "dateTimeZone"], "postprocess": 
        (d, l) => ({
          type: 'date',
          args: [
            'year',
    ...
    {"name": "dateYear", "symbols": [/[0-9]/, /[0-9]/, /[0-9]/, /[0-9]/], "postprocess": 
        (d, l, reject) => {
          return {
    ...
    {"name": "dateMonth", "symbols": [/[0-9]/, /[0-9]/], "postprocess": 
        (d, l, reject) => {
    ...
    {"name": "dateMonth", "symbols": ["literalMonth"], "postprocess": 
        (d, l) => {
    ...
    {"name": "literalMonth$subexpression$1$string$1", "symbols": [{"literal":"J"}, {"literal":"a"}, {"literal":"n"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "literalMonth$subexpression$1", "symbols": ["literalMonth$subexpression$1$string$1"]},
    {"name": "literalMonth$subexpression$1$string$2", "symbols": [{"literal":"J"}, {"literal":"a"}, {"literal":"n"}, {"literal":"u"}, {"literal":"a"}, {"literal":"r"}, {"literal":"y"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "literalMonth$subexpression$1", "symbols": ["literalMonth$subexpression$1$string$2"]},
    {"name": "literalMonth", "symbols": ["literalMonth$subexpression$1"], "postprocess": returnMonth(1)},
    {"name": "literalMonth$subexpression$2$string$1", "symbols": [{"literal":"F"}, {"literal":"e"}, {"literal":"b"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "literalMonth$subexpression$2", "symbols": ["literalMonth$subexpression$2$string$1"]},
    {"name": "literalMonth$subexpression$2$string$2", "symbols": [{"literal":"F"}, {"literal":"e"}, {"literal":"b"}, {"literal":"r"}, {"literal":"u"}, {"literal":"a"}, {"literal":"r"}, {"literal":"y"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "literalMonth$subexpression$2", "symbols": ["literalMonth$subexpression$2$string$2"]},
    {"name": "literalMonth", "symbols": ["literalMonth$subexpression$2"], "postprocess": returnMonth(2)},
    {"name": "literalMonth$subexpression$3$string$1", "symbols": [{"literal":"M"}, {"literal":"a"}, {"literal":"r"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "literalMonth$subexpression$3", "symbols": ["literalMonth$subexpression$3$string$1"]},
    {"name": "literalMonth$subexpression$3$string$2", "symbols": [{"literal":"M"}, {"literal":"a"}, {"literal":"r"}, {"literal":"c"}, {"literal":"h"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "literalMonth$subexpression$3", "symbols": ["literalMonth$subexpression$3$string$2"]},
    {"name": "literalMonth", "symbols": ["literalMonth$subexpression$3"], "postprocess": returnMonth(3)},
    {"name": "literalMonth$subexpression$4$string$1", "symbols": [{"literal":"A"}, {"literal":"p"}, {"literal":"r"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "literalMonth$subexpression$4", "symbols": ["literalMonth$subexpression$4$string$1"]},
    {"name": "literalMonth$subexpression$4$string$2", "symbols": [{"literal":"A"}, {"literal":"p"}, {"literal":"r"}, {"literal":"i"}, {"literal":"l"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "literalMonth$subexpression$4", "symbols": ["literalMonth$subexpression$4$string$2"]},
    {"name": "literalMonth", "symbols": ["literalMonth$subexpression$4"], "postprocess": returnMonth(4)},
    {"name": "literalMonth$string$1", "symbols": [{"literal":"M"}, {"literal":"a"}, {"literal":"y"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "literalMonth", "symbols": ["literalMonth$string$1"], "postprocess": returnMonth(5)},
    {"name": "literalMonth$subexpression$5$string$1", "symbols": [{"literal":"J"}, {"literal":"u"}, {"literal":"n"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "literalMonth$subexpression$5", "symbols": ["literalMonth$subexpression$5$string$1"]},
    {"name": "literalMonth$subexpression$5$string$2", "symbols": [{"literal":"J"}, {"literal":"u"}, {"literal":"n"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "literalMonth$subexpression$5", "symbols": ["literalMonth$subexpression$5$string$2"]},
    {"name": "literalMonth", "symbols": ["literalMonth$subexpression$5"], "postprocess": returnMonth(6)},
    {"name": "literalMonth$subexpression$6$string$1", "symbols": [{"literal":"J"}, {"literal":"u"}, {"literal":"l"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "literalMonth$subexpression$6", "symbols": ["literalMonth$subexpression$6$string$1"]},
    {"name": "literalMonth$subexpression$6$string$2", "symbols": [{"literal":"J"}, {"literal":"u"}, {"literal":"l"}, {"literal":"y"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "literalMonth$subexpression$6", "symbols": ["literalMonth$subexpression$6$string$2"]},
    {"name": "literalMonth", "symbols": ["literalMonth$subexpression$6"], "postprocess": returnMonth(7)},
    {"name": "literalMonth$subexpression$7$string$1", "symbols": [{"literal":"A"}, {"literal":"u"}, {"literal":"g"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "literalMonth$subexpression$7", "symbols": ["literalMonth$subexpression$7$string$1"]},
    {"name": "literalMonth$subexpression$7$string$2", "symbols": [{"literal":"A"}, {"literal":"u"}, {"literal":"g"}, {"literal":"u"}, {"literal":"s"}, {"literal":"t"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "literalMonth$subexpression$7", "symbols": ["literalMonth$subexpression$7$string$2"]},
    {"name": "literalMonth", "symbols": ["literalMonth$subexpression$7"], "postprocess": returnMonth(8)},
    {"name": "literalMonth$subexpression$8$string$1", "symbols": [{"literal":"S"}, {"literal":"e"}, {"literal":"p"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "literalMonth$subexpression$8", "symbols": ["literalMonth$subexpression$8$string$1"]},
    {"name": "literalMonth$subexpression$8$string$2", "symbols": [{"literal":"S"}, {"literal":"e"}, {"literal":"p"}, {"literal":"t"}, {"literal":"e"}, {"literal":"m"}, {"literal":"b"}, {"literal":"e"}, {"literal":"r"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "literalMonth$subexpression$8", "symbols": ["literalMonth$subexpression$8$string$2"]},
    {"name": "literalMonth", "symbols": ["literalMonth$subexpression$8"], "postprocess": returnMonth(9)},
    {"name": "literalMonth$subexpression$9$string$1", "symbols": [{"literal":"O"}, {"literal":"c"}, {"literal":"t"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "literalMonth$subexpression$9", "symbols": ["literalMonth$subexpression$9$string$1"]},
    {"name": "literalMonth$subexpression$9$string$2", "symbols": [{"literal":"O"}, {"literal":"c"}, {"literal":"t"}, {"literal":"o"}, {"literal":"b"}, {"literal":"e"}, {"literal":"r"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "literalMonth$subexpression$9", "symbols": ["literalMonth$subexpression$9$string$2"]},
    {"name": "literalMonth", "symbols": ["literalMonth$subexpression$9"], "postprocess": returnMonth(10)},
    {"name": "literalMonth$subexpression$10$string$1", "symbols": [{"literal":"N"}, {"literal":"o"}, {"literal":"v"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "literalMonth$subexpression$10", "symbols": ["literalMonth$subexpression$10$string$1"]},
    {"name": "literalMonth$subexpression$10$string$2", "symbols": [{"literal":"N"}, {"literal":"o"}, {"literal":"v"}, {"literal":"e"}, {"literal":"m"}, {"literal":"b"}, {"literal":"e"}, {"literal":"r"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "literalMonth$subexpression$10", "symbols": ["literalMonth$subexpression$10$string$2"]},
    {"name": "literalMonth", "symbols": ["literalMonth$subexpression$10"], "postprocess": returnMonth(11)},
    {"name": "literalMonth$subexpression$11$string$1", "symbols": [{"literal":"D"}, {"literal":"e"}, {"literal":"v"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "literalMonth$subexpression$11", "symbols": ["literalMonth$subexpression$11$string$1"]},
    {"name": "literalMonth$subexpression$11$string$2", "symbols": [{"literal":"D"}, {"literal":"e"}, {"literal":"c"}, {"literal":"e"}, {"literal":"m"}, {"literal":"b"}, {"literal":"e"}, {"literal":"r"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "literalMonth$subexpression$11", "symbols": ["literalMonth$subexpression$11$string$2"]},
    {"name": "literalMonth", "symbols": ["literalMonth$subexpression$11"], "postprocess": returnMonth(12)},
    {"name": "dateDay", "symbols": [/[0-9]/, /[0-9]/], "postprocess": 
        (d, l, reject) => {
    ...
    {"name": "dateHour", "symbols": [/[0-9]/, /[0-9]/], "postprocess": 
        (d, l, reject) => {
    ...
    {"name": "dateMinute", "symbols": [/[0-9]/, /[0-9]/], "postprocess": 
        (d, l, reject) => {
    ...
    {"name": "dateSecond", "symbols": [/[0-9]/, /[0-9]/], "postprocess": 
        (d, l, reject) => {
    ...
    {"name": "dateTimeZone", "symbols": [{"literal":"Z"}], "postprocess": 
        (d, l) => ({
          timezone: {
            hours: 0,
            minutes: 0
    ...
    {"name": "dateTimeZone$subexpression$1", "symbols": [{"literal":"-"}]},
    {"name": "dateTimeZone$ebnf$1$subexpression$1", "symbols": [{"literal":":"}, "int"]},
    {"name": "dateTimeZone$ebnf$1", "symbols": ["dateTimeZone$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "dateTimeZone$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "dateTimeZone", "symbols": ["dateTimeZone$subexpression$1", "int", "dateTimeZone$ebnf$1"], "postprocess": 
        (d, l) => {
          let hours = d[1].n
    ...
    {"name": "tableDef", "symbols": ["referenceName", "_", {"literal":"="}, "_", "tableColumnList"], "postprocess": 
        (d, l) => {
          const defSymbol = {
            type: 'tabledef',
            args: [d[0].name],
    ...
    {"name": "tableColumnList", "symbols": [{"literal":"{"}, "tableColDef", {"literal":"}"}], "postprocess": 
        (d, l) => {
          return {
            type: 'table-columns',
            args: d[1].coldefs,
    ...
    {"name": "factor", "symbols": ["term", "_", {"literal":"."}, "_", "propertyAccessor"], "postprocess": 
        (d, l) => ({
    ...
    {"name": "propertyAccessor", "symbols": ["referenceInExpression"], "postprocess": id},
    {"name": "timeQuantity$ebnf$1", "symbols": []},
    {"name": "timeQuantity$ebnf$1$subexpression$1", "symbols": ["timeQuantityDefParcelSeparator", "timeQuantityDefParcel"]},
    {"name": "timeQuantity$ebnf$1", "symbols": ["timeQuantity$ebnf$1", "timeQuantity$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "timeQuantity", "symbols": [{"literal":"["}, "_", "timeQuantityDefParcel", "timeQuantity$ebnf$1", "_", {"literal":"]"}], "postprocess": 
        (d, l) => {
          const parcel = d[2]
    ...
    {"name": "timeQuantityDefParcel", "symbols": ["int", "__", "timeQuantityUnit"], "postprocess": 
        (d, l) => {
          return {
    ...
    {"name": "timeQuantityUnit$subexpression$1$string$1", "symbols": [{"literal":"y"}, {"literal":"e"}, {"literal":"a"}, {"literal":"r"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "timeQuantityUnit$subexpression$1", "symbols": ["timeQuantityUnit$subexpression$1$string$1"]},
    {"name": "timeQuantityUnit$subexpression$1$string$2", "symbols": [{"literal":"y"}, {"literal":"e"}, {"literal":"a"}, {"literal":"r"}, {"literal":"s"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "timeQuantityUnit$subexpression$1", "symbols": ["timeQuantityUnit$subexpression$1$string$2"]},
    {"name": "timeQuantityUnit", "symbols": ["timeQuantityUnit$subexpression$1"], "postprocess": (d) => ({unit: "years", length: d[0][0].length })},
    {"name": "timeQuantityUnit$subexpression$2$string$1", "symbols": [{"literal":"m"}, {"literal":"o"}, {"literal":"n"}, {"literal":"t"}, {"literal":"h"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "timeQuantityUnit$subexpression$2", "symbols": ["timeQuantityUnit$subexpression$2$string$1"]},
    {"name": "timeQuantityUnit$subexpression$2$string$2", "symbols": [{"literal":"m"}, {"literal":"o"}, {"literal":"n"}, {"literal":"t"}, {"literal":"h"}, {"literal":"s"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "timeQuantityUnit$subexpression$2", "symbols": ["timeQuantityUnit$subexpression$2$string$2"]},
    {"name": "timeQuantityUnit", "symbols": ["timeQuantityUnit$subexpression$2"], "postprocess": (d) => ({unit: "months", length: d[0][0].length })},
    {"name": "timeQuantityUnit$subexpression$3$string$1", "symbols": [{"literal":"w"}, {"literal":"e"}, {"literal":"e"}, {"literal":"k"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "timeQuantityUnit$subexpression$3", "symbols": ["timeQuantityUnit$subexpression$3$string$1"]},
    {"name": "timeQuantityUnit$subexpression$3$string$2", "symbols": [{"literal":"w"}, {"literal":"e"}, {"literal":"e"}, {"literal":"k"}, {"literal":"s"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "timeQuantityUnit$subexpression$3", "symbols": ["timeQuantityUnit$subexpression$3$string$2"]},
    {"name": "timeQuantityUnit", "symbols": ["timeQuantityUnit$subexpression$3"], "postprocess": (d) => ({unit: "weeks", length: d[0][0].length })},
    {"name": "timeQuantityUnit$subexpression$4$string$1", "symbols": [{"literal":"d"}, {"literal":"a"}, {"literal":"y"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "timeQuantityUnit$subexpression$4", "symbols": ["timeQuantityUnit$subexpression$4$string$1"]},
    {"name": "timeQuantityUnit$subexpression$4$string$2", "symbols": [{"literal":"d"}, {"literal":"a"}, {"literal":"y"}, {"literal":"s"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "timeQuantityUnit$subexpression$4", "symbols": ["timeQuantityUnit$subexpression$4$string$2"]},
    {"name": "timeQuantityUnit", "symbols": ["timeQuantityUnit$subexpression$4"], "postprocess": (d) => ({unit: "days", length: d[0][0].length })},
    {"name": "timeQuantityUnit$subexpression$5$string$1", "symbols": [{"literal":"h"}, {"literal":"o"}, {"literal":"u"}, {"literal":"r"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "timeQuantityUnit$subexpression$5", "symbols": ["timeQuantityUnit$subexpression$5$string$1"]},
    {"name": "timeQuantityUnit$subexpression$5$string$2", "symbols": [{"literal":"h"}, {"literal":"o"}, {"literal":"u"}, {"literal":"r"}, {"literal":"s"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "timeQuantityUnit$subexpression$5", "symbols": ["timeQuantityUnit$subexpression$5$string$2"]},
    {"name": "timeQuantityUnit", "symbols": ["timeQuantityUnit$subexpression$5"], "postprocess": (d) => ({unit: "hours", length: d[0][0].length })},
    {"name": "timeQuantityUnit$subexpression$6$string$1", "symbols": [{"literal":"m"}, {"literal":"i"}, {"literal":"n"}, {"literal":"u"}, {"literal":"t"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "timeQuantityUnit$subexpression$6", "symbols": ["timeQuantityUnit$subexpression$6$string$1"]},
    {"name": "timeQuantityUnit$subexpression$6$string$2", "symbols": [{"literal":"m"}, {"literal":"i"}, {"literal":"n"}, {"literal":"u"}, {"literal":"t"}, {"literal":"e"}, {"literal":"s"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "timeQuantityUnit$subexpression$6", "symbols": ["timeQuantityUnit$subexpression$6$string$2"]},
    {"name": "timeQuantityUnit", "symbols": ["timeQuantityUnit$subexpression$6"], "postprocess": (d) => ({unit: "minutes", length: d[0][0].length })},
    {"name": "timeQuantityUnit$subexpression$7$string$1", "symbols": [{"literal":"s"}, {"literal":"e"}, {"literal":"c"}, {"literal":"o"}, {"literal":"n"}, {"literal":"d"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "timeQuantityUnit$subexpression$7", "symbols": ["timeQuantityUnit$subexpression$7$string$1"]},
    {"name": "timeQuantityUnit$subexpression$7$string$2", "symbols": [{"literal":"s"}, {"literal":"e"}, {"literal":"c"}, {"literal":"o"}, {"literal":"n"}, {"literal":"d"}, {"literal":"s"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "timeQuantityUnit$subexpression$7", "symbols": ["timeQuantityUnit$subexpression$7$string$2"]},
    {"name": "timeQuantityUnit", "symbols": ["timeQuantityUnit$subexpression$7"], "postprocess": (d) => ({unit: "seconds", length: d[0][0].length })},
    {"name": "timeQuantityDefParcelSeparator$subexpression$1$subexpression$1", "symbols": ["_", {"literal":","}, "_"]},
    {"name": "timeQuantityDefParcelSeparator$subexpression$1", "symbols": ["timeQuantityDefParcelSeparator$subexpression$1$subexpression$1"]},
    {"name": "timeQuantityDefParcelSeparator$subexpression$1$subexpression$2$string$1", "symbols": [{"literal":"a"}, {"literal":"n"}, {"literal":"d"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "timeQuantityDefParcelSeparator$subexpression$1$subexpression$2", "symbols": ["__", "timeQuantityDefParcelSeparator$subexpression$1$subexpression$2$string$1", "__"]},
    {"name": "timeQuantityDefParcelSeparator$subexpression$1", "symbols": ["timeQuantityDefParcelSeparator$subexpression$1$subexpression$2"]},
    {"name": "timeQuantityDefParcelSeparator$subexpression$1$subexpression$3$string$1", "symbols": [{"literal":"a"}, {"literal":"n"}, {"literal":"d"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "timeQuantityDefParcelSeparator$subexpression$1$subexpression$3", "symbols": ["_", {"literal":","}, "_", "timeQuantityDefParcelSeparator$subexpression$1$subexpression$3$string$1", "__"]},
    {"name": "timeQuantityDefParcelSeparator$subexpression$1", "symbols": ["timeQuantityDefParcelSeparator$subexpression$1$subexpression$3"]},
    {"name": "timeQuantityDefParcelSeparator", "symbols": ["timeQuantityDefParcelSeparator$subexpression$1"], "postprocess": 
        (d, l) => ({
          location: l,
          length: lengthOf(d[0][0])
        })
        },
    {"name": "range", "symbols": [{"literal":"["}, "_", "rangeSpec", "_", {"literal":"]"}], "postprocess": 
        (d, l) => {
          const range = d[2]
          return {
            ...range,
    ...
    {"name": "rangeSpec", "symbols": ["expression", "rangeParcelSeparator", "expression"], "postprocess": 
        (d, l) => {
          return {
            type: 'range',
            args: [
    ...
    {"name": "rangeParcelSeparator$subexpression$1$subexpression$1$string$1", "symbols": [{"literal":"t"}, {"literal":"h"}, {"literal":"r"}, {"literal":"o"}, {"literal":"u"}, {"literal":"g"}, {"literal":"h"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "rangeParcelSeparator$subexpression$1$subexpression$1", "symbols": ["__", "rangeParcelSeparator$subexpression$1$subexpression$1$string$1", "__"]},
    {"name": "rangeParcelSeparator$subexpression$1", "symbols": ["rangeParcelSeparator$subexpression$1$subexpression$1"]},
    {"name": "rangeParcelSeparator$subexpression$1$subexpression$2$string$1", "symbols": [{"literal":"."}, {"literal":"."}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "rangeParcelSeparator$subexpression$1$subexpression$2", "symbols": ["_", "rangeParcelSeparator$subexpression$1$subexpression$2$string$1", "_"]},
    {"name": "rangeParcelSeparator$subexpression$1", "symbols": ["rangeParcelSeparator$subexpression$1$subexpression$2"]},
    {"name": "rangeParcelSeparator", "symbols": ["rangeParcelSeparator$subexpression$1"], "postprocess": 
        (d, l) => ({
          location: l,
          length: lengthOf(d[0][0])
        })
        },
    {"name": "sequence", "symbols": [{"literal":"["}, "_", "sequenceSpec", "_", {"literal":"]"}], "postprocess": 
        (d, l) => {
          const seq = d[2]
          return {
            ...seq,
    ...
    {"name": "sequenceSpec$string$1", "symbols": [{"literal":"b"}, {"literal":"y"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "sequenceSpec", "symbols": ["rangeSpec", "_", "sequenceSpec$string$1", "_", "expression"], "postprocess": 
        (d, l) => {
          const range = d[0]
          return {
            type: "sequence",
    ...
    {"name": "statement", "symbols": ["tableDef"], "postprocess": 
        (d, l) => {
          const stmt = d[0]
          return {
            ...stmt,
