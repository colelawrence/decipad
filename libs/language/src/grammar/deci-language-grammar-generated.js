...
(function () {
  ...
  var grammar = {
    ...
    ParserRules: [
      ...
      { name: 'expression', symbols: ['nongivenex'], postprocess: id },
      { name: 'expression', symbols: ['given'], postprocess: id },
      { name: 'nongivenex', symbols: ['divMulOp'], postprocess: id },
      { name: 'nongivenex', symbols: ['table'], postprocess: id },
      { name: 'nongivenex', symbols: ['functionCall'], postprocess: id },
