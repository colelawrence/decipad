...
let ParserRules = [
  ...
  { name: 'literal', symbols: ['noNumLiteral'], postprocess: id },
  { name: 'noNumLiteral', symbols: ['boolean'], postprocess: id },
  { name: 'noNumLiteral', symbols: ['string'], postprocess: id },
  { name: 'noNumLiteral', symbols: ['percentage'], postprocess: id },
  { name: 'noNumLiteral', symbols: ['permille'], postprocess: id },
  { name: 'noNumLiteral', symbols: ['permyriad'], postprocess: id },
  { name: 'noNumLiteral', symbols: ['column'], postprocess: id },
  { name: 'noNumLiteral', symbols: ['date'], postprocess: id },
  { name: 'noNumLiteral', symbols: ['range'], postprocess: id },
  { name: 'noNumLiteral', symbols: ['sequence'], postprocess: id },
  {
    name: 'boolean',
  ...
  { name: 'divMulOp', symbols: ['fraction'], postprocess: id },
  { name: 'divMulOp', symbols: ['notFracImpMulOp'], postprocess: id },
  { name: 'divMulOp', symbols: ['slashOp'], postprocess: id },
  { name: 'divMulOp', symbols: ['noSlashMulOp'], postprocess: id },
  {
    name: 'noSlashMulOp',
    symbols: [
      'fraction',
      '_',
      'nonSlashDivMulOperator',
      '_',
      'notFracImpMulOp',
    ],
    postprocess: basicBinop,
  ...
  {
    name: 'noSlashMulOp',
    symbols: ['slashOp', '_', 'nonSlashDivMulOperator', '_', 'notFracImpMulOp'],
    postprocess: basicBinop,
  },
  {
    name: 'noSlashMulOp',
    symbols: ['noSlashMulOp', '_', 'divMulOperator', '_', 'notFracImpMulOp'],
    postprocess: basicBinop,
  },
  {
    name: 'slashOp',
    symbols: ['notNumImpMulOp', '_', 'slashOperator', '_', 'notFracImpMulOp'],
    postprocess: basicBinop,
  },
  {
    name: 'slashOp',
    symbols: ['number', '_', 'slashOperator', '_', 'notNumPowOp'],
    postprocess: basicBinop,
  },
  {
    name: 'slashOp',
    symbols: ['slashOp', '_', 'slashOperator', '_', 'notFracImpMulOp'],
    postprocess: basicBinop,
  },
  { name: 'notFracImpMulOp', symbols: ['ofExp'], postprocess: id },
  {
    name: 'notFracImpMulOp',
    symbols: ['fraction', 'ref'],
    postprocess: implicitMultHandler,
  },
  {
    name: 'notFracImpMulOp',
    symbols: ['notFracImpMulOp', 'ref'],
    postprocess: implicitMultHandler,
  },
  {
    name: 'notFracImpMulOp',
    symbols: ['fraction', '__', 'ofExp'],
    postprocess: implicitMultHandler,
  },
  {
    name: 'notFracImpMulOp',
    symbols: ['notFracImpMulOp', '__', 'ofExp'],
    postprocess: implicitMultHandler,
  },
  {
    name: 'fraction',
    symbols: ['number', '_', 'slashOperator', '_', 'number'],
    postprocess: basicBinop,
  },
  {
    name: 'fraction',
    symbols: ['fraction', '_', 'slashOperator', '_', 'number'],
    postprocess: basicBinop,
  },
  { name: 'notNumImpMulOp', symbols: ['notNumOfExp'], postprocess: id },
  {
    name: 'notNumImpMulOp',
    symbols: ['number', 'ref'],
    postprocess: implicitMultHandler,
  ...
  {
    name: 'notNumImpMulOp',
    symbols: ['notNumImpMulOp', 'ref'],
    postprocess: implicitMultHandler,
  },
  {
    name: 'notNumImpMulOp',
    symbols: ['number', '__', 'ofExp'],
    postprocess: implicitMultHandler,
  },
  {
    name: 'notNumImpMulOp',
    symbols: ['notNumImpMulOp', '__', 'ofExp'],
    postprocess: implicitMultHandler,
  },
  ...
  { name: 'notNumOfExp', symbols: ['notNumPowOp'], postprocess: id },
  {
    name: 'notNumOfExp',
    symbols: ['notNumOfExp', '_', { literal: 'of' }, '_', 'genericIdentifier'],
    postprocess: (d) => {
      return addArrayLoc(
        {
          type: 'directive',
  ...
  { name: 'notNumPowOp', symbols: ['noNumPrimary'], postprocess: id },
  {
    name: 'notNumPowOp',
    symbols: ['primary', '_', 'powOperator', '_', 'powOp'],
    postprocess: powHandler,
  ...
  { name: 'noNumPrimary', symbols: ['functionCall'], postprocess: id },
  { name: 'noNumPrimary', symbols: ['select'], postprocess: id },
  { name: 'noNumPrimary', symbols: ['matrixRef'], postprocess: id },
  { name: 'noNumPrimary', symbols: ['ref'], postprocess: id },
  { name: 'noNumPrimary', symbols: ['currency'], postprocess: id },
  {
    name: 'noNumPrimary',
  ...
  { name: 'noNumPrimary$subexpression$1', symbols: [{ literal: '!' }] },
  { name: 'noNumPrimary$subexpression$1', symbols: [{ literal: 'not' }] },
  {
    name: 'noNumPrimary',
    symbols: ['noNumPrimary$subexpression$1', '_', 'expression'],
    postprocess: (d) => {
      return addArrayLoc(
        {
          type: 'function-call',
  ...
  { name: 'divMulOperator', symbols: ['slashOperator'], postprocess: id },
  {
    name: 'divMulOperator',
    symbols: ['nonSlashDivMulOperator'],
    postprocess: id,
  },
  { name: 'slashOperator$subexpression$1', symbols: [{ literal: '/' }] },
  {
    name: 'slashOperator',
    symbols: ['slashOperator$subexpression$1'],
    postprocess: simpleOperator,
  },
  {
    name: 'nonSlashDivMulOperator$subexpression$1',
    symbols: [{ literal: 'for' }],
  },
  {
    name: 'nonSlashDivMulOperator$subexpression$1',
  ...
  {
    name: 'nonSlashDivMulOperator',
    symbols: ['nonSlashDivMulOperator$subexpression$1'],
    postprocess: simpleOperator,
  },
  {
    name: 'nonSlashDivMulOperator$subexpression$2',
    symbols: [{ literal: 'mod' }],
  },
  {
    name: 'nonSlashDivMulOperator$subexpression$2',
    symbols: [{ literal: 'modulo' }],
  },
  {
    name: 'nonSlashDivMulOperator',
    symbols: ['__', 'nonSlashDivMulOperator$subexpression$2'],
    postprocess: (d) => {
