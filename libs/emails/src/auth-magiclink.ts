                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px 0px 25px;word-break:break-word;">
                                          <div style="font-family:Arial;font-size:15px;line-height:1.8;text-align:left;color:#757575;">
                                            <div><span style="caret-color: rgb(34, 34, 34); color: rgb(34, 34, 34); font-family: Roboto, sans-serif; font-size: small; text-align: -webkit-center; word-spacing: normal;">Click the link below to complete the log in process</span><br></div>
                                          </div>
                                        </td>
                                      </tr>
                                      <tr>
                                            ...
                                            <tbody>
                                              <tr>
                                                <td align="center" bgcolor="#C1FA6B" role="presentation" style="border:none;border-radius:3px;cursor:auto;font-style:normal;mso-padding-alt:10px 25px 10px 25px;text-align:center;background:#C1FA6B;" valign="middle">
                                                  <a href="${url}" style="display:inline-block;background:#C1FA6B;color:#000000;font-family:Arial;font-size:14px;font-style:normal;font-weight:bold;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px 10px 25px;mso-padding-alt:0px;border-radius:3px;" target="_blank"> Log in now </a>
                                                </td>
                                              </tr>
                                            </tbody>
                                          </table>
                                      ...
                                      <tr>
                                        <td align="left" style="font-size:0px;padding:0px 25px 5px 25px;word-break:break-word;">
                                          <div style="font-family:&#x27;Inter&#x27;, sans-serif;font-size:12px;font-weight:normal;line-height:1.8;text-align:left;text-decoration:underline;color:#9b9b9b;"><a href="${url}">${url}</a><br></div>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
