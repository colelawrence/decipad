...
}> = ({ from, team, inviteAcceptLink }) => ({
  subject: `Decipad: ${from.name} invites you to team ${team.name}`,
  body: `
  <!doctype html>
                                        ...
                                        <tr>
                                          <td align="left" style="font-size:0px;padding:10px 25px 0px 25px;word-break:break-word;">
                                            <div style="font-family:Arial;font-size:15px;line-height:1.8;text-align:left;color:#757575;">
                                              <div><span style="caret-color: rgb(34, 34, 34); color: rgb(34, 34, 34); font-family: Roboto, sans-serif; font-size: small; text-align: -webkit-center; word-spacing: normal;">Accept the invite by clicking on the following link:</span><br></div>
                                            </div>
                                          </td>
                                        </tr>
                                        <tr>
                                              ...
                                              <tbody>
                                                <tr>
                                                  <td align="center" bgcolor="#C1FA6B" role="presentation" style="border:none;border-radius:3px;cursor:auto;font-style:normal;mso-padding-alt:10px 25px 10px 25px;text-align:center;background:#C1FA6B;" valign="middle">
                                                    <a href="${inviteAcceptLink}" style="display:inline-block;background:#C1FA6B;color:#000000;font-family:Arial;font-size:14px;font-style:normal;font-weight:bold;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px 10px 25px;mso-padding-alt:0px;border-radius:3px;" target="_blank">Join Team ${team.name}</a>
                                                  </td>
                                                </tr>
                                              </tbody>
                                            </table>
                                        ...
                                        <tr>
                                          <td align="left" style="font-size:0px;padding:10px 25px 5px 25px;word-break:break-word;">
                                            <div style="font-family:&#x27;Inter&#x27;, sans-serif;font-size:12px;font-style:italic;font-weight:normal;line-height:1.8;text-align:left;color:#c9c9c9;">
                                              <div><span style="caret-color: rgb(34, 34, 34); color: rgb(34, 34, 34); font-family: Roboto, sans-serif; font-size: small; font-style: normal; text-align: -webkit-center;">In alternative, you may use this link</span></div>
                                            </div>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td align="left" style="font-size:0px;padding:0px 25px 5px 25px;word-break:break-word;">
                                            <div style="font-family:&#x27;Inter&#x27;, sans-serif;font-size:12px;font-weight:normal;line-height:1.8;text-align:left;text-decoration:underline;color:#9b9b9b;"><a href="${inviteAcceptLink}">${inviteAcceptLink}</a><br></div>
                                          </td>
                                        </tr>
                                        <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px 5px 25px;word-break:break-word;">
                                          <div style="font-family:&#x27;Inter&#x27;, sans-serif;font-size:12px;font-style:italic;font-weight:normal;line-height:1.8;text-align:left;color:#c9c9c9;">
                                            <div><span style="caret-color: rgb(34, 34, 34); color: rgb(34, 34, 34); font-family: Roboto, sans-serif; font-size: small; font-style: normal; text-align: -webkit-center;">If you don't want to accept this invitation you can safely ignore this email</span></div>
                                          </div>
                                        </td>
                                      </tr>
                                      </tbody>
