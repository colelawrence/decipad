...
}> = ({ from, workspace, inviteAcceptLink }) => ({
  subject: `Decipad: ${from.name} invites you to workspace "${workspace.name}"`,
  body: `
  <!doctype html>
