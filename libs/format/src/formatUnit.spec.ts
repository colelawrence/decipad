...
it('can follow SI units rules and style conventions', () => {
  ...
  expect(formatUnit(locale, U([u('sqmi', { multiplier: F(1, 100) })]))).toEqual(
    'cmi²'
  );
  expect(formatUnit(locale, U([u('sqyd', { multiplier: F(1, 100) })]))).toEqual(
    'cyd²'
  );
  expect(formatUnit(locale, U([u('sqft', { multiplier: F(1, 100) })]))).toEqual(
    'cft²'
  );
  expect(formatUnit(locale, U([u('sqin', { multiplier: F(1, 100) })]))).toEqual(
    'cin²'
  );
  ...
  expect(formatUnit(locale, U([u('F', { multiplier: F(1) })]))).toEqual('F');
  expect(formatUnit(locale, U([u('Hz', { multiplier: F(1) })]))).toEqual('Hz');
  expect(formatUnit(locale, U([u('hz', { multiplier: F(1) })]))).toEqual('Hz');
  expect(formatUnit(locale, U([u('W', { multiplier: F(1) })]))).toEqual('W');
  expect(formatUnit(locale, U([u('w', { multiplier: F(1) })]))).toEqual('W');
  expect(formatUnit(locale, U([u('°c', { multiplier: F(1) })]))).toEqual('°C');
  expect(formatUnit(locale, U([u('°C', { multiplier: F(1) })]))).toEqual('°C');
  expect(formatUnit(locale, U([u('SEK', { multiplier: F(1) })]))).toEqual('kr');
