...
export const Warning: FC<{ variant?: 'default' | 'warning' }> = ({
  variant = 'default',
}) => (
  <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path
      ...
      fill={
        variant === 'default'
          ? cssVar('iconBackground')
          : cssVar('stateWarningIconBackground')
      }
      stroke={
        variant === 'default'
          ? cssVar('iconColorHeavy')
          : cssVar('stateWarningIconOutline')
      }
      strokeWidth="1.2"
      strokeLinecap="round"
