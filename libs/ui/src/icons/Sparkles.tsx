  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={0.8}
        d="M11.049 4.272C10.619 5 9.759 5 9.399 5c.36 0 1.22.146 1.65.728s.55 1.166.573 1.772c0-.46.209-1.279.574-1.772.43-.582 1.29-.728 1.648-.728-.358 0-1.218 0-1.648-.728a4 4 0 0 1-.574-1.772 4.1 4.1 0 0 1-.573 1.772Z"
      />
    </svg>
  );
};
