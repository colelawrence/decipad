  ...
  return (
    <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path
        ...
        fill={teal100.rgb}
      />
      <rect x="6" y="19" width="28" height="2" rx="1" fill={teal500.rgb} />
      <rect x="25" y="19" width="9" height="2" rx="1" fill={teal200.rgb} />
      <g filter={`url(#${filterId})`}>
        <rect x="15" y="14" width="12" height="12" rx="6" fill="white" />
        <rect
          x="14.35"
          y="13.35"
          width="13.3"
