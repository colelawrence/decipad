...
export const ThumbnailCsvLight = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      ...
      {...props}
    >
      <title>ThumbnailCsvLight</title>
      <rect width={40} height={40} fill="#ECF0F6" rx={8} />
      <g clipPath="url(#ThumbnailCSVLight_svg__a)">
        <path
          stroke="#4D5664"
          strokeLinecap="round"
      ...
      <defs>
        <clipPath id="ThumbnailCSVLight_svg__a">
