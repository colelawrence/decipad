...
export const ThumbnailSqlLight = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      ...
      {...props}
    >
      <title>ThumbnailSqlLight</title>
      <rect width={40} height={40} fill="#ECF0F6" rx={8} />
      <g stroke="#4D5664" clipPath="url(#ThumbnailSQLLight_svg__a)">
        <path
          strokeLinecap="round"
      ...
      <defs>
        <clipPath id="ThumbnailSQLLight_svg__a">
