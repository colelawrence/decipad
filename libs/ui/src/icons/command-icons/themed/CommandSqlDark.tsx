...
export const CommandSqlDark = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      ...
      {...props}
    >
      <title>CommandSqlDark</title>
      <rect width={40} height={40} fill="#29283A" rx={8} />
      <g clipPath="url(#CommandSQLDark_svg__a)">
        <path
          stroke="#9B9AAC"
          strokeLinecap="round"
      ...
      <defs>
        <clipPath id="CommandSQLDark_svg__a">
