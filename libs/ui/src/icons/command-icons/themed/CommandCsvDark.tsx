...
export const CommandCsvDark = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      ...
      {...props}
    >
      <title>CommandCsvDark</title>
      <rect width={40} height={40} fill="#29283A" rx={8} />
      <g clipPath="url(#CommandCSVDark_svg__a)">
        <path
          stroke="#9B9AAC"
          strokeLinecap="round"
      ...
      <defs>
        <clipPath id="CommandCSVDark_svg__a">
