...
export const CommandImageDark = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg
    ...
    >
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.3}
        d="M18.915 20.823a625 625 0 0 0 2.576-3.31l.01-.013a2 2 0 0 1 3.085-.06L27 20.25"
      />
    </svg>
  );
};
