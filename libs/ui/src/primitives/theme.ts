...
> = {
  ...
  ...setCssVar('notebookStateDangerLight', red300.rgb),
  ...setCssVar('notebookStateDangerHeavy', red100.rgb),
  ...setCssVar('notebookStateWarningLight', orange300.rgb),
  ...setCssVar('notebookStateWarningHeavy', orange100.rgb),
  ...setCssVar('notebookStateOkHeavy', brand100.rgb),
  ...setCssVar('notebookStateOkLight', brand600.rgb),
  ...setCssVar('notebookStateDisabledLight', grey600.rgb),
  ...setCssVar('notebookStateDisabledHeavy', grey100.rgb),
  ...
  ...setCssVar('magicNumberTextColor', brand200.rgb),
