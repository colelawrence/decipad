...
export const Normal: StoryFn<ComponentProps<typeof NumberResult>> = (
  props: CodeResultProps<'number'>
) => <NumberResult {...props} />;
...
export const Unit: StoryFn<ComponentProps<typeof NumberResult>> = (
  props: CodeResultProps<'number'>
) => <NumberResult {...props} />;
