...
export function parse_csv(a: number, b: number, c: number, d: number): void;
...
export function computebackend_insert_number_column(a: number, b: number, c: number, d: number): void;
