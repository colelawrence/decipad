...
function getBigUint64Memory0() {
  if (
    ...
    cachedBigUint64Memory0.byteLength === 0
  ) {
...
/**
 */
export const DeciType = Object.freeze({
  Number: 0,
  0: 'Number',
  String: 1,
  1: 'String',
...
/**
 */
export const ComputeErrors = Object.freeze({
  IncorrectType: 0,
  0: 'IncorrectType',
  UnknownId: 1,
  1: 'UnknownId',
...
const ComputeBackendFinalization =
...
export class ComputeBackend {
  ...
  insert_number_column(id, value) {
    try {
      ...
      wasm.computebackend_insert_number_column(
        this.__wbg_ptr,
        ptr0,
        len0,
  ...
  sum_from_js(value) {
    try {
      const ret = wasm.computebackend_sum_from_js(
        this.__wbg_ptr,
        addBorrowedObject(value)
      );
      return ret;
  ...
  sum_from_js_frac(numerators, denominator) {
    try {
      ...
      wasm.computebackend_sum_from_js_frac(
        retptr,
        this.__wbg_ptr,
        ptr0,
        len0,
  ...
  gt_mask(id, n, d) {
    try {
      ...
      const len0 = WASM_VECTOR_LEN;
      wasm.computebackend_gt_mask(retptr, this.__wbg_ptr, ptr0, len0, n, d);
      var r0 = getInt32Memory0()[retptr / 4 + 0];
      var r1 = getInt32Memory0()[retptr / 4 + 1];
      var r2 = getInt32Memory0()[retptr / 4 + 2];
      if (r2) {
  ...
  ge_mask(id, n, d) {
    try {
      ...
      const len0 = WASM_VECTOR_LEN;
      wasm.computebackend_ge_mask(retptr, this.__wbg_ptr, ptr0, len0, n, d);
      var r0 = getInt32Memory0()[retptr / 4 + 0];
      var r1 = getInt32Memory0()[retptr / 4 + 1];
      var r2 = getInt32Memory0()[retptr / 4 + 2];
      if (r2) {
  ...
  lt_mask(id, n, d) {
    try {
      ...
      const len0 = WASM_VECTOR_LEN;
      wasm.computebackend_lt_mask(retptr, this.__wbg_ptr, ptr0, len0, n, d);
      var r0 = getInt32Memory0()[retptr / 4 + 0];
      var r1 = getInt32Memory0()[retptr / 4 + 1];
      var r2 = getInt32Memory0()[retptr / 4 + 2];
      if (r2) {
  ...
  le_mask(id, n, d) {
    try {
      ...
      const len0 = WASM_VECTOR_LEN;
      wasm.computebackend_le_mask(retptr, this.__wbg_ptr, ptr0, len0, n, d);
      var r0 = getInt32Memory0()[retptr / 4 + 0];
      var r1 = getInt32Memory0()[retptr / 4 + 1];
      var r2 = getInt32Memory0()[retptr / 4 + 2];
      if (r2) {
  ...
  eq_mask(id, n, d) {
    try {
      ...
      const len0 = WASM_VECTOR_LEN;
      wasm.computebackend_eq_mask(retptr, this.__wbg_ptr, ptr0, len0, n, d);
      var r0 = getInt32Memory0()[retptr / 4 + 0];
      var r1 = getInt32Memory0()[retptr / 4 + 1];
      var r2 = getInt32Memory0()[retptr / 4 + 2];
      if (r2) {
