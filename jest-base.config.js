...
module.exports = {
  ...
  transformIgnorePatterns: [
    'node_modules/(?!(lib0|y-protocols|@udecode/plate-.*|nanoid|@decipad/safejs|@formkit/auto-animate|.*dnd.*|next-auth|is-stream|get-stream|langchain|jsonpath-plus|react-tweet)/)',
    '\\.pnp\\.[^\\/]+$',
  ],
