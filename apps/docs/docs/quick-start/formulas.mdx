...
5. **Shorthand Notation**:
   ...
   - You can use currency symbols such as `$5` or `5$` to represent different currencies. <br/>
     [Check Supported Currencies →](/docs/advanced-concepts/units)
...
7. **Add Units**:
   ...
   - To add units you can just type them. For example enter `$10` or `5oz` to indicate a currency or measurement. <br/>
     [Learn more about Units →](/docs/advanced-concepts/units)

8. **Reference Results**:

   - You can easily drag and drop these calculations into your text to explain them. <br/>[Learn more about Inline Results →](/docs/quick-start/inline-numbers)
