...
| [ceil()](round)                                             | ceil(Number, [Precision])      | Rounds up a number to a specified number of decimal places or to the nearest whole number.   |
| [factorial()](factorial)                                    | factorial(Number)              | Computes factorials, which are commonly used in probability calculations.                    |
| [floor()](round)                                            | floor(Number, [Precision])     | Rounds down a number to a specified number of decimal places or to the nearest whole number. |
| [getunit()](get-number-units)                               | getunit(Number)                | Retrieves the units of a given number.                                                       |
...
| [rounddown()](round)                                        | rounddown(Number, [Precision]) | Rounds down a number to a specified number of decimal places or to the nearest whole number. |
| [roundup()](round)                                          | roundup(Number, [Precision])   | Rounds up a number to a specified number of decimal places or to the nearest whole number.   |
| [precision()](round)                                        | precision(Number, [Precision]) | Rounds a number to a specified number of decimal places or to the nearest whole number.      |
...
| [stripunit()](remove-number-units)                          | stripunit(Number)              | Removes the units from a number, allowing you to work with the numbers alone.                |
...
| [avg()](average)             | avg(Column)                       | Calculates the average of a column.                                                                    |
| [avgif()](average)           | avgif(Column)                     | Calculates the average of a column given a condition.                                                  |
| [cat()](concatenate)         | cat(Table, Table)                 | Combines two tables into a new table.                                                                  |
...
| [grab()](filter)             | grab(Table, Condition)            | Filters table rows based on a condition.                                                               |
| [grow()](grow)               | grow(Initial, Rate, Column)       | Calculates the compound growth of an initial value across rows.                                        |
| [lag()](previous)            | lag(InitialValue, [Column])       | References the previous value within a table.                                                          |
...
| [mean()](average)            | mean(Column)                      | Calculates the average of a column.                                                                    |
| [median()](median)           | median(Column)                    | Calculates the median of a column.                                                                     |
| [min()](min)                 | min(Column)                       | Calculates the smallest number from a column of numbers or the earliest date from a column of dates.   |
| [len()](count)               | len(Column)                       | Counts the number of rows in a column.                                                                 |
...
| [stddev()](variance)         | stddev(Column)                    | Calculates the standard deviation of a column.                                                         |
...
| [total()](sum)               | total(Column)                     | Calculates the sum of a column.                                                                        |
| [trend()](trend)             | tren(Column)                      | Calculates the percentage inscrease of a column.                                                       |
| [unique()](unique)           | unique(Column)                    | Extracts the unique values from a column.                                                              |
| [variance()](variance)       | variance(Column)                  | Calculates the standard deviation of a column.                                                         |
