...
Inline numbers are now easier to identify by anyone reading your notebook. These are numbers you can add into your text to highlight results that update automatically when there are changes to your model.

[Learn more about Inline Numbers](/basic-concepts/inline-numbers)

<br/>

### <FancyTitle icon={Hammer}>Fixes and Improvements</FancyTitle>

- **Inline numbers were redesigned**, so anyone can tell they are connected to your model.
...
- Hovering inline numbers to see their formula, now displays formulas of any size correctly.
