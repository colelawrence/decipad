var D=Object.create;var r=Object.defineProperty;var k=Object.getOwnPropertyDescriptor;var I=Object.getOwnPropertyNames,y=Object.getOwnPropertySymbols,R=Object.getPrototypeOf,p=Object.prototype.hasOwnProperty,_=Object.prototype.propertyIsEnumerable;var f=e=>r(e,"__esModule",{value:!0}),a=(e,t)=>r(e,"name",{value:t,configurable:!0});var h=(e,t)=>{var n={};for(var i in e)p.call(e,i)&&t.indexOf(i)<0&&(n[i]=e[i]);if(e!=null&&y)for(var i of y(e))t.indexOf(i)<0&&_.call(e,i)&&(n[i]=e[i]);return n};var T=(e,t)=>{for(var n in t)r(e,n,{get:t[n],enumerable:!0})},A=(e,t,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let i of I(t))!p.call(e,i)&&i!=="default"&&r(e,i,{get:()=>t[i],enumerable:!(n=k(t,i))||n.enumerable});return e},C=e=>A(f(r(e!=null?D(R(e)):{},"default",e&&e.__esModule&&"default"in e?{get:()=>e.default,enumerable:!0}:{value:e,enumerable:!0})),e);f(exports);T(exports,{handler:()=>Y});var v=a(({from:e,to:t,team:n,inviteAcceptLink:i})=>({subject:`${e.name} invites you to team ${n.name}`,body:`Dear ${t.name},
...
The Deci team.
`}),"default");var b={"team-invite":v,"email-validation":g,"auth-magiclink":E,"workspace-invite":S,"generic-invite":$};var w=C(require("aws-sdk")),x={apiVersion:"2019-09-27",accessKeyId:process.env.DECI_SES_ACCESS_KEY_ID,secretAccessKey:process.env.DECI_SES_SECRET_ACCESS_KEY,region:"eu-west-2"},j=new w.SESV2(x),d=process.env.DECI_FROM_EMAIL_ADDRESS;if(!d)throw new Error("Environment variable DECI_FROM_EMAIL_ADDRESS is not defined");function m({to:e,body:t,subject:n}){return new Promise((i,o)=>{let l={Content:{Simple:{Body:{Text:{Data:t,Charset:"UTF-8"}},Subject:{Data:n,Charset:"UTF-8"}}},Destination:{ToAddresses:[e]},FromEmailAddress:d,ReplyToAddresses:[d]};j.sendEmail(l,c=>{if(c)return o(c);i()})})}a(m,"sendEmail");function u(e){return async t=>{for(let n of t.Records){let i=JSON.parse(n.body);await e(i)}return{}}}a(u,"queueHandler");var Y=u(F),H=!!process.env.JEST_WORKER_ID;async function F(n){var i=n,{template:e}=i,t=h(i,["template"]);if(H)return;let o=b[e];if(!o)throw new Error(`Could not find template with name ${e}`);let{subject:l,body:c}=o(t);await m({to:t.email||t.to.email,body:c,subject:l})}a(F,"handleSendEmail");0&&(module.exports={handler});
